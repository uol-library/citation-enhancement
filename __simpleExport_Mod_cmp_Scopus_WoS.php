...
$rowHeadings = Array("CIT-TYPE", "CIT-TITLE", "CIT-AUTHORS", "CIT-DOI", "SCOPUS-SEARCH", "SCOPUS-TITLE", "SCOPUS-AUTHORS", "SCOPUS-DOI", "SCOPUS-SIMILARITY-MAX", "SCOPUS-COUNTRIES-DISTINCT", "WOS-SEARCH", "WOS-TITLE", "WOS-AUTHORS", "WOS-DOI", "WOS-SIMILARITY-MAX", "WOS-AUTHOR-COUNTRIES-DISTINCT", "WOS-FLOAT-COUNTRIES-DISTINCT", "WOS-REPRINT-COUNTRIES-DISTINCT");
            ...
            if (
                ...
                if (isset($citation["Scopus"])) {
                    ...
                    if (isset($citation["Scopus"]["first-match"]) && isset($citation["Scopus"]["first-match"]["authors"])) {
                        ...
                        $outputRecord["SCOPUS-COUNTRIES-DISTINCT"] = Array();
                        
                        
                        $outputRecord["SCOPUS-TITLE"] = $citation["Scopus"]["first-match"]["summary"]["dc:title"];
                        if (isset($citation["Scopus"]["first-match"]["summary"]["prism:doi"])) {
                            $outputRecord["SCOPUS-DOI"] = $citation["Scopus"]["first-match"]["summary"]["prism:doi"];
                        } else {
                            $outputRecord["SCOPUS-DOI"] = NULL;
                        }
                                ...
                                foreach ($author["affiliation"] as $authorAffiliation) {
                                    ...
                                    if (isset($authorAffiliation["country"])) {
                                        if (isset($namesToCodesMap[strtolower($authorAffiliation["country"])])) {
                                            ...
                                            $outputRecord["SCOPUS-COUNTRIES-DISTINCT"][] = $nationalityCode;
                        ...
                        if ($countSimilarity) {
                            $outputRecord["SCOPUS-SIMILARITY-AVG"] = floor($totalSimilarity/$countSimilarity);
                            $outputRecord["SCOPUS-SIMILARITY-MIN"] = $minSimilarity;
                            $outputRecord["SCOPUS-SIMILARITY-MAX"] = $maxSimilarity;
                        }
                        
                        $outputRecord["SCOPUS-COUNTRIES-DISTINCT"] = array_unique($outputRecord["SCOPUS-COUNTRIES-DISTINCT"]);
                        sort($outputRecord["SCOPUS-COUNTRIES-DISTINCT"]); // gives something comparable with other sources 
                ...
                if (isset($citation["VIAF"])) {
                    ...
                    $outputRecord["VIAF-COUNTRIES-DISTINCT"] = Array();
                            ...
                            foreach (Array("NAT"=>"nationalities") as $fieldCode=>$countryField) {
                                ...
                                if (isset($viafCitation["best-match"][$countryField]) && is_array($viafCitation["best-match"][$countryField])) {
                                    ...
                                    foreach ($viafCitation["best-match"][$countryField] as $nationality) {
                                        ...
                                        if ($nationalityCode!==NULL) {
                                            $thisAuthorCountries[] = $nationalityCode;
                                            $outputRecord["VIAF-COUNTRIES-DISTINCT"][] = $nationalityCode;
                    ...
                    if ($countSimilarity) {
                        ...
                        $outputRecord["VIAF-SIMILARITY-AVG"] = floor($totalSimilarity/$countSimilarity);
                        $outputRecord["VIAF-SIMILARITY-MIN"] = $minSimilarity;
                        $outputRecord["VIAF-SIMILARITY-MAX"] = $maxSimilarity;
                    ...
                    $outputRecord["VIAF-COUNTRIES-DISTINCT"] = array_unique($outputRecord["VIAF-COUNTRIES-DISTINCT"]);
                    sort($outputRecord["VIAF-COUNTRIES-DISTINCT"]); // gives something comparable with other sources
